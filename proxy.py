...
#--------------------------------------------------------------------------
    ...
    try:
        ...
        print "verify port is available via netstat -an | grep %d" % (int(local_port))
        sys.exit(0)
...
#--------------------------------------------------------------------------
    ...
    while True:
        ...
        if len(local_buffer):
            ...
            # send data to our request handler
...
#---------------------------------------    
    if len(sys.argv[1:]) != 5:
        print "Usage: ./proxy.py 127.0.0.1 9000 10.12.13.1 9000 True"
        sys.exit(0)
    ...
    # this tells our proxy to connect and receive data before sending it to the remote host
    ...
    if "True" in receive_first:
        ...
        receive_first = False
    # not spin up our listening socket
